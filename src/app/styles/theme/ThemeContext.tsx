...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const toggleMode = useCallback(() => {
    ...
    console.log(
      '🔍 [THEME DEBUG] toggleMode called, switching from',
      actualMode,
      'to',
      newMode
    );
    handleSetMode(newMode);
  }, [actualMode, mounted, handleSetMode]);
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty(
      '--theme-background',
      computedMode === 'light' ? '#ffffff' : gray[900],
      'important'
    );
    document.documentElement.style.setProperty(
      '--theme-text',
      computedMode === 'light' ? gray[800] : '#ffffff',
      'important'
    );
    document.documentElement.style.setProperty(
      '--theme-paper',
      computedMode === 'light' ? '#ffffff' : gray[800],
      'important'
    );
    document.documentElement.style.setProperty(
      '--theme-divider',
      computedMode === 'light' ? gray[200] : gray[700],
      'important'
    );
