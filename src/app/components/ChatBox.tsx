...
const EXAMPLE_QUESTIONS = [
  {
    text: "What's the best bank bonus right now?",
                ...
                <>
                  ...
                  >
                    <Typography variant="body1" sx={{ lineHeight: 1.6 }}>
                      Hi! I can help you find the best financial opportunities across
                      banks, credit cards, and brokerages. What would you like to know?
                    </Typography>
                  </Box>
                  <Typography
                    variant="caption"
              ...
              {isTyping && (
                ...
                >
                  ...
                  <Typography variant="body2" sx={{ letterSpacing: 0.3 }}>
                    Thinking... Let me find the best opportunities for you.
                  </Typography>
                </Box>
              )}
              {error && (
