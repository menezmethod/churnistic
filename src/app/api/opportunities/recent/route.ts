      ...
      .map((opp) => {
        try {
          return {
            ...
            sourceLink: opp.institution_details.offer_link,
            ...
            metadata: {
              ...
              bonus: {
                value: opp.bonus.value,
                description: opp.bonus.description,
                requirements: opp.bonus.requirements,
                details: opp.bonus.details,
                tiers: opp.bonus.tiers,
              },
              availability: {
                regions: opp.availability.regions,
                details: opp.availability.details,
                household_limit: opp.availability.household_limit,
              },
              lastVerified: opp.timing.last_verified,
              tracking: {
                first_seen: opp.tracking.first_seen,
                last_seen: opp.tracking.last_seen,
                times_seen: opp.tracking.times_seen,
                source_history: opp.tracking.source_history,
              },
            },
          };
        } catch (error) {
